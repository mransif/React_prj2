...
function Cards() {
    return (
        <div className='w-full h-screen flex items-center gap-5 bg-zinc-800 px-[3vw]'>
            <div className='w-1/2  h-[30vw]'>
                <div className='w-full h-full relative rounded-lg bg-[#004D43] flex items-center justify-center'>
                    <svg width="102" height="60" color='yellow' viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className='absolute top-[25vw] left-[3vw] border-zinc-400 border-2 px-3 py-1 rounded-full'>Check</button>
                </div>
            </div>
            <div className='w-1/2 flex  h-[30vw] gap-5'>
                <div className='w-1/2 h-full relative rounded-lg flex items-center justify-center bg-[#082722]'>
                    <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
                    <button className='absolute top-[25vw] left-[2vw] border-zinc-400 border-2 px-3 py-1 rounded-full'>Check</button>
                </div>
                <div className='w-1/2 h-full relative rounded-lg flex items-center justify-center bg-[#082722]'>
